...
# ---------------------------------------------------------------------------
HELP_TEXT = (
    "ℹ️ <b>NASIL OYNANIR?</b>\n\n"
    "<b>🎮 Oyunlar</b> — Slot, mayın, blackjack, rulet, roket, çark, zar, yazı-tura ile "
    "altın bahis edip katlarsın. Beceri oyunları (bilgi, matematik, kelime, refleks) "
    "bedavadır, bilgi ve hızla altın kazandırır.\n\n"
    "<b>⚔️ PVP</b> — Arkadaşınla altın karşılığı düello: taş-kağıt-makas, XOX, emoji zar, "
    "gerçek arena savaşı, gizemli kutu. Grupta açtığın düelloyu herkes kabul edebilir.\n\n"
    "<b>🏪 Market & 🛒 Pazar</b> — Silah/zırh/evcil hayvan al, yükselt (+10'a kadar), "
    "kendi fiyatınla oyuncu pazarında sat.\n\n"
    "<b>🐉 Boss</b> — Herkesin birlikte vurduğu dünya bossu. Hasarın kadar pay alırsın.\n\n"
    "<b>🏰 Klan</b> — Klan kur, bağış yap, seviye atlat: tüm üyeler kazanç bonusu alır.\n\n"
    "<b>🏦 Banka</b> — Faiz kazanır, soygundan korur.\n"
    "<b>🥷 Soygun</b> — /soy @kisi ile başkasının cebindekini çalmayı dene.\n"
    "<b>🏭 İşletme</b> — Pasif gelir; 4 saatte bir kasayı topla.\n"
    "<b>🎟 Piyango</b> — Bilet al, havuzu kap.\n"
    "<b>📜 Görevler</b> — Günlük 3 görev + başarımlar.\n\n"
    "<b>📋 KOMUTLAR</b>\n"
    "/start /menu /profil /bakiye\n"
    "/oyunlar /duello /kabul /parti\n"
...
EARN_TEXT = (
    "💸 <b>ALTIN KAZANMA YOLLARI</b>\n\n"
    "🎁 <b>/gunluk</b> — her gün, seri arttıkça büyür\n"
    "⏰ <b>/saatlik</b> — her saat küçük bonus\n"
    "💼 <b>Çalış</b> — 45 dakikada bir garanti gelir\n"
    "⛏ <b>Maden</b> — 20 dakikada bir, elmas şansı\n"
    "🗡 <b>Arena</b> — enerji harcar, ekipmanın güçlüyse çok kazandırır\n"
    "🧠 <b>Beceri oyunları</b> — risksiz, dakikada bir\n"
    "🐉 <b>Boss</b> — en yüksek toplu ödül\n"
    "🎟 <b>Piyango</b> — düşük şans, büyük havuz\n"
    "🏭 <b>İşletme</b> — uyurken kazan\n"
    "🏦 <b>Banka faizi</b> — günde %2\n"
    "👥 <b>Davet</b> — kişi başı 10.000 🪙 + 2 💎\n"
    "⚔️ <b>PVP</b> — arkadaşının altınını kap\n"
    "🛒 <b>Pazar</b> — ucuza al, pahalıya sat (tüccarlık)\n\n"
    "<i>İpucu: kazandığını bankaya yatır, soygundan korunur.</i>"
)
